    ...
    <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-sm w-full">
      <div className="px-5 md:px-10 lg:px-20">
        <div className="max-w-[1440px] mx-auto">
          ...
          {/* ── Mobile nav — no hamburger, CTA always visible ── */}
          <div className="flex md:hidden items-center justify-between py-3">
            <Link href="/">
              <div className="relative h-[48px] w-[122px]">
                <Image
                  src="/images/logo.png"
                  alt="Sucress logo"
                  fill
            ...
            <a
              href="#free-offer"
              className="inline-flex items-center justify-center h-9 px-4 bg-[#97e674] rounded-full text-[#064326] font-semibold text-[13px] whitespace-nowrap active:scale-[0.97] transition-transform duration-100"
            >
              Get Free Supply
            </a>
          </div>

          <div className="md:hidden h-px bg-[#00723c]/10" />
